...
const categories = ["Tous", "Cuisson", "Réfrigération", "Laverie", "Préparation", "Mobilier", "Bar", "Caisse"]
        ...
        {!loading && annonces.length === 0 && (
          <div className="text-center py-24" style={{ color: 'var(--chr-muted)' }}>
            <p className="text-lg font-medium mb-4">
              {categorie ? `Aucune annonce en "${categorie}"` : 'Aucune annonce pour le moment'}
            </p>
            <Link
              href="/publier"
...
export default function Annonces() {
  return (
    <main className="min-h-screen" style={{ background: 'var(--chr-bg)' }}>
      ...
      <Suspense fallback={<div className="text-center py-20 text-sm" style={{ color: 'var(--chr-muted)' }}>Chargement...</div>}>
        <AnnoncesList />
      </Suspense>
    </main>
  )
